...
/**
 * View class for a list of Notificationary.
 *
 * @since  1.6
 */
class NotificationaryViewRules extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		NotificationaryHelper::addSubmenu('rules');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_NOTIFICATIONARY_TITLE_RULES'), 'rules.png');
		...
		{
			JToolBarHelper::preferences('com_notificationary');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_notificationary&view=rules');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_NOTIFICATIONARY_RULES_TITLE'),
		);
	}
