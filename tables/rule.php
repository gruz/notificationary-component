 ...
 * @since  1.6
 */
class NotificationaryTablerule extends JTable
{
	/**
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_notificationary.rule.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_notificationary/access.xml',
				"/access/section[@name='rule']/"
			);
			$default_actions = JAccess::getAssetRules('com_notificationary.rule.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_notificationary.rule.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_notificationary');
